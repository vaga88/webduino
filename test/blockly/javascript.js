Blockly.JavaScript['matrix_led_char'] = function(block) {
  ...
  var code = 'MatrixLed_char("'+ value_char__.replace(/\'/g,"") +'");';
  return code;
};
...
Blockly.JavaScript['matrix_led_marquee'] = function(block) {
  ...
  var code = 'MatrixLed_marquee("'+ value_marquee__.replace(/\'/g,"") +'");';
  return code;
};
...
Blockly.JavaScript['matrix_led_sample'] = function(block) {
  ...
  var code = 'MatrixLed_sample("'+ value_sample__.replace(/\'/g,"") +'");';
  return code;
};
...
Blockly.JavaScript['matrix_led_code'] = function(block) {
  ...
  var code = 'MatrixLed_code("'+ value_code__.replace(/\'/g,"") +'");';
  return code;
};
