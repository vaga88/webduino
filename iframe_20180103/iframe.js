+(function (window, document) {
  ...
  function createIframe(input_url_,input_WIDTH_,input_HEIGHT_,input_LEFT_,input_TOP_) {
    ...
    if (substr[substr.length-1].indexOf("aac,aif,au,aif,aiff,ape,asf,avi,cda,dat,flac,mp3,mid,mp4,m4a,mov,mpg,mpeg,m2ts,ogg,pdf,ra,rcp,rm,rmvb,snd,vob,voc,wma,wav,wmf,wmv,xmi")!=-1)
